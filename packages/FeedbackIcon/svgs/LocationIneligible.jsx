...
const LocationIneligible = ({ copy, ...rest }) => {
  const locationIneligibleA = uniqueId('locationineligible-a')
  return (
    <FeedbackIcon {...rest}>
      <FeedbackIconSVG
