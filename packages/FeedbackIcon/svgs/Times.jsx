...
const Times = ({ a11yText, ...rest }) => {
  const timesA = uniqueId('times-a')
  const timesB = uniqueId('times-b')
    ...
    <FeedbackIcon {...rest}>
      ...
      >
        ...
        <g fill="none" fillRule="evenodd" transform="translate(2 2)">
          <mask id={timesB} fill={colorWhite}>
            <use xlinkHref={`#${timesA}`} />
          </mask>
          <use fill={colorShark} xlinkHref={`#${timesA}`} />
          <g fill={colorCardinal} mask={`url(#${timesB})`}>
