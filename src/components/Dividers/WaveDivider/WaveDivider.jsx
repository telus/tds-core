...
const WaveDivider = ({ ...rest }) => (
  ...
  >
    <defs>
      ...
      <linearGradient
        id="TDS_wave-divider_gradient-2"
        x1="600"
        y1="224.7"
        x2="600"
        y2="70.2"
      ...
      <linearGradient
        id="TDS_wave-divider_gradient-3"
        x1="146.95"
        y1="82.92"
        x2="146.95"
        y2="122.08"
        xlinkHref="#TDS_wave-divider_gradient"
      />
      <linearGradient
        id="TDS_wave-divider_gradient-4"
        x1="146.95"
        y1="224.7"
        x2="146.95"
        y2="70.2"
        xlinkHref="#TDS_wave-divider_gradient-2"
      />
      <linearGradient
        id="TDS_wave-divider_gradient-5"
        x1="1076.11"
        y1="102.31"
        x2="1076.11"
        y2="163.51"
      ...
      />
      <linearGradient
        id="TDS_wave-divider_gradient-6"
        x1="1128.83"
        y1="213.27"
        x2="1061.33"
        y2="87.28"
      ...
      />
      <linearGradient
        id="TDS_wave-divider_gradient-7"
        x1="28.8"
        y1="115"
        x2="170.73"
        y2="115"
      ...
      <linearGradient
        id="TDS_wave-divider_gradient-8"
        x1="1185.42"
        y1="113.95"
        x2="1041.42"
        y2="115.95"
        xlinkHref="#TDS_wave-divider_gradient-7"
      />
      <linearGradient
        id="TDS_wave-divider_gradient-9"
        x1="601"
        y1="-2"
        x2="601"
        y2="52.08"
      ...
      />
      <linearGradient
        id="TDS_wave-divider_gradient-10"
        x1="600.78"
        y1="222.98"
        x2="600.78"
        y2="160.94"
      ...
      />
      <linearGradient
        id="TDS_wave-divider_gradient-11"
        x1="601.22"
        y1="64.89"
        x2="601.22"
        y2="2.85"
    ...
    <g dataname="Layer 1">
      <g dataname="Layer 1">
        <path
          className={styles.TDS_waveDivider_class1}
        ...
        />
        <g className={styles.TDS_waveDivider_class2}>
          <path
            className={styles.TDS_waveDivider_class3}
          ...
          />
          <g className={styles.TDS_waveDivider_class4}>
        ...
        <path
          className={styles.TDS_waveDivider_class5}
        ...
        <g className={styles.TDS_waveDivider_class2}>
          <path
            className={styles.TDS_waveDivider_class6}
        ...
        <path
          className={styles.TDS_waveDivider_class7}
          d="M293.89 144.8C202.25 139.8 90.58 126.67 0 114.45V143.9C56.54 151.74 114.92 158 157.12 158 202.23 158 247.91 152.8 293.89 144.8Z"
        />
        <g className={styles.TDS_waveDivider_class2}>
          <path
            className={styles.TDS_waveDivider_class8}
        ...
        <path
          className={styles.TDS_waveDivider_class9}
          d="M952.21 79.89c94.67 20 190.24 48.11 247.79 66.1V103.05C1134.77 89.47 1065.13 78 1016 78 994.85 78 973.58 78.68 952.21 79.89Z"
        />
        <rect className={styles.TDS_waveDivider_class10} width="180" height="226" />
        <rect className={styles.TDS_waveDivider_class11} x="1020" width="180" height="226" />
        <rect className={styles.TDS_waveDivider_class12} y="154" width="1202" height="72" />
      </g>
    </g>
    <g dataname="Layer 2">
      <rect className={styles.TDS_waveDivider_class13} y="158.3" width="1201.56" height="67.5" />
      <rect
        className={styles.TDS_waveDivider_class14}
        x="0.44"
        y="0.21"
        width="1201.56"
        height="67.5"
