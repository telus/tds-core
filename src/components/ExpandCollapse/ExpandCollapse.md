...
Need to adjust the panel spacing so that the outlines of the input fields are visible.
...
Need to get a real example for a disabled panel.
Also need to adjust the alignment of the header text when disabled.
